...
const defaultPaths = ['/', 'settings', '/history', '/own-posts', '/all-posts', '/class', '/company-lists', '/company/:uuid', '/test'];
...
const userUrl = `${API_URL}/api/protected`;

function App() {
    const { data } = useFetchData1(userUrl, headers);
